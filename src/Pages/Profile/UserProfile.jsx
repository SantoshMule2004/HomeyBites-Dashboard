            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="row mt-3">
                        <div className="col-md-4 mb-1" onClick={()=> navigate("/update-business-details")}>
                            <div className="card p-3 shadow profile-div">
                        ...
                        <div className="col-md-4 mb-1" onClick={()=> navigate("/update-profile")}>
                            <div className="card p-3 shadow profile-div">
                                <div className='p-2 pe-3 d-flex justify-content-center align-items-center' style={{ height: '100px' }}>
